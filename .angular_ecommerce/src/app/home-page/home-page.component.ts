...
@Component({
  ...
  imports: [OrganicShareComponent,CategoryComponent,DailyOffersComponent,DiscountComponent,DownloadAppComponent,ImageComponent,ItemOnSaleComponent ,OurrecentBlogsComponent,PeopleLookingForComponent],
